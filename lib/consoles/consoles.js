...
define( "consoles", [ "jquery" ], function( $ ) {
    ...
    consoles.prototype = {
        ...
        __init : function() {
            ...
            $( `<div class="consoles-contents"></div>` )
                .appendTo( $e );

            $e.find( '.consoles-n, .consoles-s, .consoles-w, .consoles-e, .consoles-nw, .consoles-ne, .consoles-sw, .consoles-se' )
        ...
        log : function( str ) {
            var $e = $( this.__ele );
            var $c = $e.find( '.consoles-contents' );
            var time = new Date();
            ...
            $c.append( `<p>[${time_str}] ${str}</p>` );
            $c.scrollTop( 999999999 );
        }
    }
